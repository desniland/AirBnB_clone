...
class TestUser(unittest.TestCase):
    """ Test for subclass User"""

    def test_docstring(self):
        '''test if funcions, methods, classes
        and modules have a docstring'''
        msj = "Módulo does not have a docstring"
        self.assertIsNotNone(models.user.__doc__, msj)  # Modules
        msj = "Clase does not have a docstring"
    ...
    def test_init_User(self):
        """test if an object is of type User"""
        my_object = User()
    ...
    def test_save(self):
        """ check if date is updated when saved """
        my_objectupd = User()
    ...
    def test_to_dict(self):
        '''checks if to_dict returns a dictionary, if add a class
